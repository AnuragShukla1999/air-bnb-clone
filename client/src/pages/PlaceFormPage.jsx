  ...
  return (
    <div>
      ...
      <form onSubmit={savePlace}>
        ...
        <textarea value={extraInfo} onChange={e => setExtraInfo(ee.target.value)} ></textarea>


        {preInput('Check input times', 'add check in and out times, remember to have some time window for cleaning the room between guests')}
