...
const jwtSecret = "vhshfjsdjbnvcjdslhfgouidsuofg";
...
app.post('/api/upload', photoMiddleware.array('photo', 100), async (req, res) => {
    const uploadedFiles = [];
...
app.put('/api/places', async (req, res) => {
    ...
    const {
        id, title, address, addedPhotos, description, perks, extraInfo, checkIn, maxGuests, price,
    } = req.body;
